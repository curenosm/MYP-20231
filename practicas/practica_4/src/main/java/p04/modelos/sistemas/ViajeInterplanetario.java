...
/**
 * Clase que representa un sistema de propulsion para viajes interplanetarios. Extiende de la clase
 * SistemaDePropulsion.
 *
...
public class ViajeInterplanetario extends SistemaDePropulsion {
  ...
  public ViajeInterplanetario() {
    ...
    this.descripcion =
        "Sistema de propulsion que permite viajar entre planetas de una misma galaxia";
