...
/**
 * Clase que representa un sistema de propulsion para viajes intercontinentales. Extiende de la
...
public class ViajeIntercontinental extends SistemaDePropulsion {
  ...
  public ViajeIntercontinental() {
    ...
    this.descripcion =
        "Sistema de propulsion que permite viajar entre continentes dentro de un mismo planeta";
